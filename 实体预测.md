...
![img](file:///C:/Users/婷婷/AppData/Local/Temp/msohtmlclip1/01/clip_image012.jpg)

查准率：指的是预测值为1且真实值也为1的样本在预测值为1的所有样本中所占的比例

![img](file:///C:/Users/婷婷/AppData/Local/Temp/msohtmlclip1/01/clip_image014.png)

查全率：指的是预测值为1且真实值也为1的样本在真实值为1的所有样本中所占的比例

![img](file:///C:/Users/婷婷/AppData/Local/Temp/msohtmlclip1/01/clip_image016.png)

### 3.2F1分数

F1分数（F1-Score）被定义为查准率和查全率的调和平均数

![img](file:///C:/Users/婷婷/AppData/Local/Temp/msohtmlclip1/01/clip_image018.png)
...
![img](file:///C:/Users/婷婷/AppData/Local/Temp/msohtmlclip1/01/clip_image020.png)

 

**构造出的数据如下：**

![img](file:///C:/Users/婷婷/AppData/Local/Temp/msohtmlclip1/01/clip_image022.jpg)

其中将yi转换成了id，这对应一个topic2num.pk文件，将160中实体对应0~159的数字

**topic2num.pk的数据格式如下**：

![img](file:///C:/Users/婷婷/AppData/Local/Temp/msohtmlclip1/01/clip_image024.jpg)
...
![image-20210511191711466](C:\Users\婷婷\AppData\Roaming\Typora\typora-user-images\image-20210511191711466.png)
